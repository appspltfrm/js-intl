...
export class IntlBundleGenerator {
    ...
    generate() {
        ...
        for (let baseLocale of this.locales) {
            ...
            if (intlPolyfill) {
                contents.unshift("{var INTL_POLYFILL=[];", "if(typeof window !== 'undefined'){INTL_POLYFILL=window['INTL_POLYFILL']=(window['INTL_POLYFILL']||[]);}", "if(typeof globalThis !== 'undefined'){INTL_POLYFILL=globalThis['INTL_POLYFILL']=(globalThis['INTL_POLYFILL']||[]);}", "}");
            }
            if (intlRelativeTimePolyfill) {
                contents.unshift("{var INTL_RELATIVE_POLYFILL=[];", "if(typeof window !== 'undefined'){INTL_RELATIVE_POLYFILL=window['INTL_RELATIVE_POLYFILL']=(window['INTL_RELATIVE_POLYFILL']||[]);}", "if(typeof globalThis !== 'undefined'){INTL_RELATIVE_POLYFILL=globalThis['INTL_RELATIVE_POLYFILL']=(globalThis['INTL_RELATIVE_POLYFILL']||[]);}", "}");
            }
