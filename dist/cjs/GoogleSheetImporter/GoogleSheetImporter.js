...
const fileSystem = tslib_1.__importStar(require("fs-extra"));
...
class GoogleSheetImporter {
    ...
    async readCsv(document) {
        return new Promise(async (resolve, reject) => {
            const data = {};
            (0, parse_1.parseString)(await this.fetchHttps(`https://docs.google.com/spreadsheets/d/e/${document.id}/pub?output=csv&${document.worksheet ? `&gid=${document.worksheet}&single=true` : ""}`), { headers: true })
